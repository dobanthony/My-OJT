<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <router-link class="navbar-brand" to="/">OJT Tracker</router-link>
      <button 
      ...
      <div class="collapse navbar-collapse" id="studentNavbar">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/student/dtr">OJT Time Tracker</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" to="/student/avatar">Profile</router-link>
          </li>
          <!-- User Dropdown -->
